...
export DISPLAY = 114.114.114.114:0.0
config = {
...
def convert_to_solution_generation_prefix(item_dict):
    ...
    if "golden_question_list" in item_dict and "golden_answer_list" in item_dict:
...
def get_chatGPT_response(prompt):
    ...
    messege = chatbot.get_chat_response(prompt, output="text")
    output = messege
    return output

get_chatGPT_response("Please write a poem!\n")
